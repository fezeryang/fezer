...
> = {
  ...
  builder: {
    tools: ["get_profile", "get_skills", "get_projects", "ask_other_agent"],
  ...
  writer: {
    tools: ["get_profile", "get_skills", "get_interests", "ask_other_agent"],
  ...
  wanderer: {
    tools: ["get_profile", "get_interests", "ask_other_agent"],
    canConsult: ["reader", "visual"],
  },
};
