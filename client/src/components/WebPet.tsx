...
import { getStoredPosition, setStoredPosition } from "./web-pet/storage";
...
export default function WebPet() {
  ...
  const clampPosition = useCallback(
    (pos: Position, dimensions: PetDimensions = petDimensions): Position => {
      const maxX = Math.max(MIN_X, window.innerWidth - dimensions.width);
      const maxY = Math.max(MIN_Y, window.innerHeight - dimensions.height);
